...
case $city_choice in
    1)
        ...
        stream="rtp/239.77.0.213:5146"
        channel_key="广东"
#        url_fofa=$(echo  '"udpxy" && country="CN" && region="Guangdong" && org="Chinanet" && protocol="http"' | base64 |tr -d '\n')
#        url_fofa="https://fofa.info/result?qbase64="$url_fofa
        url_fofa="https://raw.githubusercontent.com/zjykfy/ceshi/refs/heads/main/Guangdong_dianxin.txt"$url_fofa
        ;;
    0)
